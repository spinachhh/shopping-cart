                ...
                <ul class="cart-item-list">
                  <li v-for="(item,index) in productList">
                    ...
                    <div class="cart-tab-2">
                      <div class="item-price">{{item.productPrice | fomatMoney}}</div>
                    </div>
                    ...
                    <div class="cart-tab-4">
                      <div class="item-price-total">{{item.productPrice*item.productQuantity | fomatMoney}}</div>
                    </div>
                    <div class="cart-tab-5">
                      <div class="cart-item-operation">
                        <a href="javascript:void 0" class="item-edit-btn" @click="delFlag=true;pindex=index">
            ...
            <div class="cart-foot-wrap">
              ...
              <div class="cart-foot-r">
                <div class="item-total">
                  Item total: <span class="total-price">{{totalMoney | fomatMoney}}</span>
                </div>
...
<script>
	...
	export default{
	    ...
	    methods:{
	    	cartView:function(){
                this.$http.get('../static/axios/cartData.json').then( (res) => {
	    	...
	    	selectedProduct:function(item){
	    		...
	    		for(var i = 0;i<this.productList.length;i++){
	    			if(this.productList[i].checked){this.checkAllFlag = true;}else{this.checkAllFlag = false;break;}
	    		}
	    		this.calcTotalPrice();
	    	},
