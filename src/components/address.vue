    ...
    <div class="container">
      <div class="checkout-addr">
        ...
        <div class="addr-list-wrap">
          <div class="addr-list">
            <ul>
              <li v-for="(item,index) in filterAddress" :class="{'check':index == curIndex}" @click="curIndex = index">
                <dl>
                  <dt>{{item.userName}}</dt>
              ...
              <li class="addr-new" @click="addProduct()">
...
export default {
  ...
  methods:{
    getAddressList(){
      this.$http.get('../static/axios/address.json')
        .then( res =>{
